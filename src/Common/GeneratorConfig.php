...
class GeneratorConfig
{
    ...
    public $nsResource;
    public $nsResourceCollection;
    public $nsSearch;

    public $nsApiController;
    public $nsApiRequest;
    public $nsApiResource;
    public $nsApiResourceCollection;
    ...
    public $pathApiResourceCollection;
    ...
    public function loadNamespaces(CommandData &$commandData)
    {
        ...
        $this->nsSearch = config('infyom.laravel_generator.namespace.search','App\Search');
        ...
        $this->nsApiResource = config('infyom.laravel_generator.namespace.api_resource','App\Http\Resource\Api');
        $this->nsApiResourceCollection = config('infyom.laravel_generator.namespace.api_resource_collection','App\Http\Resource\Api');

        $this->nsResource = config('infyom.laravel_generator.namespace.resource','App\Http\Resource\Admin');
        $this->nsResourceCollection = config('infyom.laravel_generator.namespace.resource_collection','App\Http\Resource\Admin');
    ...
    public function loadPaths()
    {
        ...
        $this->pathResourceCollection = config(
                'infyom.laravel_generator.path.resource_collection',
                app_path('Http/Resources/Admin/')
            ).$prefix;
        ...
        $this->pathSearch = config('infyom.laravel_generator.path.search', app_path('Search/')).$prefix;
        ...
        $this->pathApiResourceCollection = config(
                'infyom.laravel_generator.path.api_resource_collection',
                app_path('Http/Resources/Api/')
            ).$prefix;
        ...
        $this->pathRequest = config('infyom.laravel_generator.path.request', app_path('Http/Requests/Admin/')).$prefix;
...
//        );
    ...
    public function loadDynamicVariables(CommandData &$commandData)
    {
        ...
        $commandData->addDynamicVariable('$NAMESPACE_SEARCH$', $this->nsSearch);
        ...
        $commandData->addDynamicVariable('$NAMESPACE_RESOURCE_COLLECTION$', $this->nsResourceCollection);
        ...
        $commandData->addDynamicVariable('$NAMESPACE_API_RESOURCE_COLLECTION$', $this->nsApiResourceCollection);
